  ...
  return (
    ...
    id = "contact" className='w-full px-[12%] py-10 scroll-mt-20 bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center bg-[length:90%_auto] dark:bg-none'>
        ...
        className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>
            Have questions or need a repair? We’re here to help! Whether it’s a routine maintenance check or an urgent fix, we bring expert automotive services directly to you. Contact us today to book an appointment or get a free quote. Fill out the form below, and we’ll get back to you as soon as possible! 🚗🔧
        </motion.p>
        <motion.form 
        initial={{ opacity: 0 }}
        whileInView={{ opacity: 1 }}
